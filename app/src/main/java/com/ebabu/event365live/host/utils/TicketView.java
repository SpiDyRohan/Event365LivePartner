...
public class TicketView extends View {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            mScallopRadius = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketScallopRadius, Utility.dpToPx(20f, getContext()));
            ...
            mBorderWidth = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketBorderWidth, Utility.dpToPx(2f, getContext()));
            ...
            mDividerWidth = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketDividerWidth, Utility.dpToPx(2f, getContext()));
            ...
            mDividerDashLength = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketDividerDashLength, Utility.dpToPx(8f, getContext()));
            mDividerDashGap = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketDividerDashGap, Utility.dpToPx(4f, getContext()));
            mCornerType = typedArray.getInt(R.styleable.TicketView_ticketCornerType, CornerType.NORMAL);
            mCornerRadius = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketCornerRadius, Utility.dpToPx(4f, getContext()));
            mDividerPadding = typedArray.getDimensionPixelSize(R.styleable.TicketView_ticketDividerPadding, Utility.dpToPx(10f, getContext()));
            float elevation = 0f;
    ...
    private void setShadowBlurRadius(float elevation) {
        ...
        float maxElevation = Utility.dpToPx(24f, getContext());
