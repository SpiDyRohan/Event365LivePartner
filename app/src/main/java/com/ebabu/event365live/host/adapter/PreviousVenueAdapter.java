...
public class PreviousVenueAdapter extends RecyclerView.Adapter<PreviousVenueAdapter.FuelAdapterViewHolder> {
    ...
    public PreviousVenueAdapter(VenueClickListener listener){
